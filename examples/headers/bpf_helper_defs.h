 ...
 * 	pseudo-random intern state, and cannot be used to infer the
 ...
 * 	clsact TC egress hook, this has the advantage that, internly,
 ...
 * 	counter intern to the BPF infrastructure, that is used to
 ...
 * 	consumed.
 *
 * 	Note that if a socket closes with the intern counter holding
