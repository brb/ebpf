...
func mustKernelVersion() intern.Version {
...
func CheckFeatureTest(t *testing.T, fn func() error) {
	...
	var ufe *intern.UnsupportedFeatureError
...
func checkKernelVersion(tb testing.TB, ufe *intern.UnsupportedFeatureError) {
...
func SkipOnOldKernel(tb testing.TB, minVersion, feature string) {
	...
	minv, err := intern.NewVersion(minVersion)
	if err != nil {
