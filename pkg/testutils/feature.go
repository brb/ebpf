...
func MustKernelVersion() pkg.Version {
...
func CheckFeatureTest(t *testing.T, fn func() error) {
	...
	var ufe *pkg.UnsupportedFeatureError
...
func checkKernelVersion(tb testing.TB, ufe *pkg.UnsupportedFeatureError) {
